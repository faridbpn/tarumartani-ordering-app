...
<body class="bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen flex items-center justify-center p-6">
  ...
  <div class="bg-gray-800/60 border border-gray-700/50 backdrop-blur-lg shadow-2xl rounded-2xl p-10 max-w-xl text-center relative overflow-hidden w-full">
    ...
    <div class="floating mb-6">
      <div class="w-24 h-24 bg-yellow-500/10 rounded-full flex items-center justify-center mx-auto">
        <i class="fas fa-lock text-yellow-500 text-5xl animate__animated animate__shakeY animate__infinite"></i>
      </div>
    </div>

    <!-- Title -->
    <h1 class="text-4xl font-bold gradient-text animate__animated animate__fadeIn">Access Restricted</h1>
    ...
    <p class="text-sm text-gray-500 mt-6 animate__animated animate__fadeInUp animate__delay-2s">
      Need access? 
      <a href="/contact" class="text-blue-400 hover:text-blue-300 transition">Contact support</a>
    </p>
  </div>
